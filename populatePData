/*
	Load the commodity meta data
*/
SELECT "Update commodity meta data";

INSERT INTO pData.commodities (dsCode, dsDescription) 
SELECT 	l.dsCode
,		l.dsDescription
FROM 	pLoad.commodityMeta l
ON DUPLICATE KEY UPDATE dsDescription = l.dsDescription;

SELECT Count(*) FROM pData.commodities;

/*
	Load the commodity values
*/
SELECT "Update commodity values";


INSERT INTO pData.commodityValues (dsCode, valueDate, value) 
SELECT 	l.dsCode
,		l.valueDate
,		l.value
FROM 	pLoad.commodityLoadSimple l
ON DUPLICATE KEY UPDATE
		valueDate = l.valueDate
,		value = l.value;

SELECT Count(*) FROM pData.commodityValues;
